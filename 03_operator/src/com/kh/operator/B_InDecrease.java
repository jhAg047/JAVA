...
public class B_InDecrease {
	...
	public void method4() {
		...
		System.out.println(a++); //10 a=11 b=20 c=30
		System.out.println((++a) + (b++)); //12+20 = 32 a=12 b=21 c=30
